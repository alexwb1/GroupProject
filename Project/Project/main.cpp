...
void mainMenu(Bank inputBank){
    ...
    do {
        ...
        cout << " " << endl;
        float totalValueOfInvestment = 0;
        ...
        totalValueOfInvestment = UsersBank.getInvestment1().getTotalInvestment();
        newAccountBalance = UsersBank.getAccountBalance() - totalValueOfInvestment;
        UsersBank.setAccountBalance(newAccountBalance);
        cout << " " << endl;
        ////////////INVESTMENT 1////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        totalValueOfInvestment = UsersBank.getInvestment2().getTotalInvestment();
        newAccountBalance = UsersBank.getAccountBalance() - totalValueOfInvestment;
        UsersBank.setAccountBalance(newAccountBalance);
        cout << " " << endl;
        ////////////INVESTMENT 2////////////
        ...
        totalValueOfInvestment = UsersBank.getInvestment3().getTotalInvestment();
        newAccountBalance = UsersBank.getAccountBalance() - totalValueOfInvestment;
        UsersBank.setAccountBalance(newAccountBalance);
        cout << " " << endl;
        ////////////INVESTMENT 3////////////
        ...
        totalValueOfInvestment = UsersBank.getInvestment4().getTotalInvestment();
        newAccountBalance = UsersBank.getAccountBalance() - totalValueOfInvestment;
        UsersBank.setAccountBalance(newAccountBalance);
        cout << " " << endl;
        ////////////INVESTMENT 4////////////
        ...
        totalValueOfInvestment = UsersBank.getInvestment5().getTotalInvestment();
        newAccountBalance = UsersBank.getAccountBalance() - totalValueOfInvestment;
        UsersBank.setAccountBalance(newAccountBalance);
        cout << " " << endl;
        ////////////INVESTMENT 5////////////
        ...
        cout << "Now that you have made your investment decisions..." << endl;
...
Investment createInvestment(Bank userBank, Investment userInvestmentInput) {
    ...
    while (investmentResearcher) {
        ...
        cout << " " << endl;
        cout << "Investable Profit: $" << UsersBank.getAccountBalance() << endl;
